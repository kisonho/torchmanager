...
class Checkpoint:
    ...
    def __init__(self, model: torch.nn.Module, epoch: int=0, optimizer: Optional[torch.optim.Optimizer]=None, loss_fn: Optional[Loss]=None, metrics: Optional[Dict[str, Metric]]=None, save_weights_only: bool=False) -> None:
        '''
        Constructor
